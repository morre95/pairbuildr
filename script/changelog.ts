...
Generates UPCOMING_CHANGELOG.md by running the pairbuildr changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for pairbuildr run (default: low)
      --quiet            Suppress pairbuildr command output unless it fails
