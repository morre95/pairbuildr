...
import type { AssistantMessage as PairBuildrAssistantMessage, Message } from "@pairbuildr/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@pairbuildr/core/effect/app-node"
...
export type AssistantTokenCost = Pick<PairBuildrAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<PairBuildrAssistantMessage, "role"> &
  Partial<Pick<PairBuildrAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@pairbuildr/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@pairbuildr/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@pairbuildr/ACPUsage") {}
