...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@pairbuildr/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@pairbuildr/ACPDirectory") {}
