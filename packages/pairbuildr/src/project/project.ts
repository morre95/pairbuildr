...
import { ProjectDirectoryTable, ProjectTable } from "@pairbuildr/core/project/sql"
import { ProjectDirectories } from "@pairbuildr/core/project/directories"
...
import { which } from "@pairbuildr/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.PAIRBUILDR_FAKE_VCS)
