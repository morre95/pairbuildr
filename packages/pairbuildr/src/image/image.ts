...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __PAIRBUILDR_PHOTON_WASM_PATH?: string }).__PAIRBUILDR_PHOTON_WASM_PATH =
