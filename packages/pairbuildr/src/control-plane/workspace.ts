...
import { EventSequenceTable, EventTable } from "@pairbuildr/core/event/sql"
...
import { WorkspaceEvent } from "@pairbuildr/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        PAIRBUILDR_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        PAIRBUILDR_WORKSPACE_ID: config.id,
        PAIRBUILDR_EXPERIMENTAL_WORKSPACES: "true",
