...
import { NonNegativeInt } from "@pairbuildr/core/schema"
...
export const ExperimentalApi = HttpApi.make("experimental")
      ...
      .add(
        HttpApiEndpoint.get("capabilities", ExperimentalPaths.capabilities, {
          ...
          OpenApi.annotations({
            ...
            description: "Get experimental features enabled on the PairBuildr server.",
          }),
        ),
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local PairBuildr state.",
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all PairBuildr sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "pairbuildr experimental HttpApi",
      version: "0.0.1",
