...
>()("@pairbuildr/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@pairbuildr/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.PAIRBUILDR_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.PAIRBUILDR_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-pairbuildr-directory"] || process.cwd()
}
