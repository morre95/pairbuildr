 ...
 *   "@pairbuildr/ServerAuthConfig",
 *   {
 *     password: Config.string("PAIRBUILDR_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("PAIRBUILDR_SERVER_USERNAME").pipe(Config.withDefault("pairbuildr")),
 *   },
 * ) {}
 *
