...
import { buildPrompt } from "@pairbuildr/core/session/compaction"
import { SessionCompactionEvent } from "@pairbuildr/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/SessionCompaction") {}
