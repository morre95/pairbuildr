import type { JsonSchema, LLMRequest, ProviderMetadata } from "@pairbuildr/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@pairbuildr/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @pairbuildr/llm request objects from pairbuildr's session/AI SDK-shaped data.
  return LLM.request({
