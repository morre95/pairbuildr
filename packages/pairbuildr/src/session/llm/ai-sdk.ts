import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@pairbuildr/llm"
...
// Move this extraction into @pairbuildr/llm when Copilot is handled by the native runtime.
