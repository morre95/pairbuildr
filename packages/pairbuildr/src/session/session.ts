...
import { Slug } from "@pairbuildr/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@pairbuildr/llm"
...
import { locationServiceMapLayer } from "@pairbuildr/core/location-services"
...
import { PartTable, SessionTable } from "@pairbuildr/core/session/sql"
...
import { NonNegativeInt, optional } from "@pairbuildr/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".pairbuildr", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/Session") {}
