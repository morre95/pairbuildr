...
//
// The saved variant persists across sessions in ~/.local/state/pairbuildr/model.json
...
class Service extends Context.Service<Service, VariantService>()("@pairbuildr/RunVariant") {}
