// Shared type vocabulary for the direct interactive mode (`pairbuildr --mini`).
//
...
import type { PairbuildrClient, PermissionRequest, QuestionRequest, ToolPart } from "@pairbuildr/sdk/v2"
import type { TuiConfig } from "@pairbuildr/tui/config"
...
type PromptModel = Parameters<PairbuildrClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<PairbuildrClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<PairbuildrClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<PairbuildrClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<PairbuildrClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<PairbuildrClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<PairbuildrClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<PairbuildrClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<PairbuildrClient["question"]["reject"]>[0]
