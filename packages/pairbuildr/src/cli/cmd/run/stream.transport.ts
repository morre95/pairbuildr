...
import type { Event, GlobalEvent, PairbuildrClient } from "@pairbuildr/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@pairbuildr/RunStreamTransport") {}
