...
import { openEditor } from "@pairbuildr/tui/editor"
import { registerPairbuildrKeymap } from "@pairbuildr/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerPairbuildrKeymap(keymap, renderer, input.tuiConfig)
