import type { Session as SDKSession, Message, Part } from "@pairbuildr/sdk/v2"
...
import { SessionTable, MessageTable, PartTable } from "@pairbuildr/core/session/sql"
...
export const ImportCommand = effectCmd({
  command: "import <file>",
  describe: "read a session from json",
  builder: (yargs) =>
