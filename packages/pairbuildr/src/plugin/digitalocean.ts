import type { Hooks, PluginInput } from "@pairbuildr/plugin"
import type { Model } from "@pairbuildr/sdk/v2"
import { InstallationVersion } from "@pairbuildr/core/installation/version"
import { OauthCallbackPage } from "@pairbuildr/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. PairBuildr will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
