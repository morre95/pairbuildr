...
import { AccountStateTable, AccountTable } from "@pairbuildr/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/AccountRepo") {}
