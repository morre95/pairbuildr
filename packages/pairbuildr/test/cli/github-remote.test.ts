...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pairbuildr.git")).toEqual({ owner: "sst", repo: "pairbuildr" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/pairbuildr")).toEqual({ owner: "sst", repo: "pairbuildr" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pairbuildr.git")).toEqual({ owner: "sst", repo: "pairbuildr" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/pairbuildr")).toEqual({ owner: "sst", repo: "pairbuildr" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pairbuildr.git")).toEqual({ owner: "sst", repo: "pairbuildr" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/pairbuildr")).toEqual({ owner: "sst", repo: "pairbuildr" })
})
