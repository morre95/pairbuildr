...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips pairbuildr-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-pairbuildr-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-pairbuildr-directory")).toBeNull()
      expect(result.get("x-pairbuildr-workspace")).toBeNull()
