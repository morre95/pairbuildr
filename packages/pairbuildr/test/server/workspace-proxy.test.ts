...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips pairbuildr-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-pairbuildr-directory"]).toBeUndefined()
      expect(forwarded["x-pairbuildr-workspace"]).toBeUndefined()
