...
import { makeGlobalNode } from "@pairbuildr/core/effect/app-node"
...
import { InstallationChannel } from "@pairbuildr/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/pairbuildr/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/pairbuildr/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/pairbuildr/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("<OWNER>/tap/pairbuildr")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("pairbuildr")) return "pairbuildr"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("<OWNER>/tap/pairbuildr") && args.includes("--formula"))
            return "pairbuildr"
