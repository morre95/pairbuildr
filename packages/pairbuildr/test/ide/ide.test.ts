...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PAIRBUILDR_CALLER", () => {
    process.env["PAIRBUILDR_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PAIRBUILDR_CALLER", () => {
    process.env["PAIRBUILDR_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PAIRBUILDR_CALLER", () => {
    process.env["PAIRBUILDR_CALLER"] = "unknown"
