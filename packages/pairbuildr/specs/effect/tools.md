...
Practical reference for the current tool-migration state in `packages/pairbuildr`.
...
Tool tests should use the existing Effect helpers in `packages/pairbuildr/test/lib/effect.ts`:
