...
import type { IntegrationOAuthMethodRegistration } from "@pairbuildr/plugin/v2/effect/integration"
import { define } from "@pairbuildr/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `PairBuildr/${InstallationVersion}` }
}
