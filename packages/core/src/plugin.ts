...
import type { Plugin as PluginRuntime } from "@pairbuildr/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/v2/Plugin") {}
