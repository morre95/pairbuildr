...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for pairbuildr serve and web commands",
  }),
  ...
  share_url: Schema.optional(Schema.String).annotate({
    description:
      "Base URL of the session sharing service. Has no default: sharing is unavailable until you set this to a service you control.",
  }),
