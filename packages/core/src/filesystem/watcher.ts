...
import { FileSystemWatcher } from "@pairbuildr/schema/filesystem-watcher"
...
declare const PAIRBUILDR_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof PAIRBUILDR_LIBC === "undefined" ? undefined : PAIRBUILDR_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.PAIRBUILDR_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.PAIRBUILDR_EXPERIMENTAL_FILEWATCHER)) {
