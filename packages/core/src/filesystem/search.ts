...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(
  Effect.sync(() => (Flag.PAIRBUILDR_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
