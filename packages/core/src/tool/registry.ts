...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@pairbuildr/llm"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/v2/ToolRegistry") {}
