...
import { ListAnchor } from "@pairbuildr/schema/session"
...
import { SessionDurable } from "@pairbuildr/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/v2/Session") {}
