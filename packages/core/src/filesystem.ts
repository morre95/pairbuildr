...
import { Entry, FileSystem, FindInput, Match } from "@pairbuildr/schema/filesystem"
export { Entry, Match, Submatch } from "@pairbuildr/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/v2/FileSystem") {}
