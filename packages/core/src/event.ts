...
import type { Data, Definition, Payload } from "@pairbuildr/schema/event"
...
import { Durable } from "@pairbuildr/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@pairbuildr/schema/event").ID
export type { Data, Definition, Payload } from "@pairbuildr/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/Event") {}
