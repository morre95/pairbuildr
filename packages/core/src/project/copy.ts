...
import { Event } from "@pairbuildr/schema/project-directories"
import { ProjectCopy } from "@pairbuildr/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/ProjectCopy") {}
