...
import type { EffectDrizzleSqlite } from "@pairbuildr/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@pairbuildr/ProjectDirectories") {}
