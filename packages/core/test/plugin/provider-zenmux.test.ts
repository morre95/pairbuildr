...
import { ProviderPlugins } from "@pairbuildr/core/plugin/provider"
import { ZenmuxPlugin } from "@pairbuildr/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/<OWNER>/<REPO>", "X-Title": "pairbuildr" })
