...
import { AgentV2 } from "@pairbuildr/core/agent"
import { ModelV2 } from "@pairbuildr/core/model"
import { SessionV2 } from "@pairbuildr/core/session"
import { Agent } from "@pairbuildr/schema/agent"
import { Location } from "@pairbuildr/schema/location"
import { Model } from "@pairbuildr/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@pairbuildr/schema/prompt"
import { Provider } from "@pairbuildr/schema/provider"
import { Project } from "@pairbuildr/schema/project"
import { ProjectDirectories } from "@pairbuildr/schema/project-directories"
import { PermissionV1 } from "@pairbuildr/schema/permission-v1"
import { Session } from "@pairbuildr/schema/session"
import { SessionInput } from "@pairbuildr/schema/session-input"
import { SessionMessage } from "@pairbuildr/schema/session-message"
import { Workspace } from "@pairbuildr/schema/workspace"
import { Command } from "@pairbuildr/schema/command"
import { Connection } from "@pairbuildr/schema/connection"
import { Credential } from "@pairbuildr/schema/credential"
import { FileSystem } from "@pairbuildr/schema/filesystem"
import { Integration } from "@pairbuildr/schema/integration"
import { LLM } from "@pairbuildr/schema/llm"
import { Permission } from "@pairbuildr/schema/permission"
import { Plugin } from "@pairbuildr/schema/plugin"
import { Pty } from "@pairbuildr/schema/pty"
import { Reference } from "@pairbuildr/schema/reference"
import { SessionTodo } from "@pairbuildr/schema/session-todo"
import { Skill } from "@pairbuildr/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@pairbuildr/schema/schema"
import { ProviderV2 } from "@pairbuildr/core/provider"
import { PluginV2 } from "@pairbuildr/core/plugin"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@pairbuildr/core/command"),
    import("@pairbuildr/core/integration/connection"),
    import("@pairbuildr/core/credential"),
    import("@pairbuildr/core/filesystem"),
    import("@pairbuildr/core/integration"),
    import("@pairbuildr/core/location"),
    import("@pairbuildr/llm"),
    import("@pairbuildr/core/permission"),
    import("@pairbuildr/core/v1/permission"),
    import("@pairbuildr/core/project/copy"),
    import("@pairbuildr/core/pty"),
    import("@pairbuildr/core/project/schema"),
    import("@pairbuildr/core/reference"),
    import("@pairbuildr/core/session/input"),
    import("@pairbuildr/core/session/message"),
    import("@pairbuildr/core/session/todo"),
    import("@pairbuildr/core/session/prompt"),
    import("@pairbuildr/core/skill"),
    import("@pairbuildr/core/v2-schema"),
    import("@pairbuildr/core/schema"),
    import("@pairbuildr/core/workspace"),
  ])
