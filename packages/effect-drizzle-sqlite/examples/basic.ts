...
class Database extends Context.Service<Database, DatabaseShape>()("@pairbuildr/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@pairbuildr/example/UserStore") {
