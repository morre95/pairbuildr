...
Schema-first LLM core for pairbuildr. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@pairbuildr/llm"
import { OpenAI } from "@pairbuildr/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@pairbuildr/llm/providers"
