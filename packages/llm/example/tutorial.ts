...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@pairbuildr/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@pairbuildr/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-pairbuildr-tutorial": "1" },
    query: { debug: "1" },
  },
})
