...
import { useBindings, usePairbuildrModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = usePairbuildrModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.PAIRBUILDR_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
