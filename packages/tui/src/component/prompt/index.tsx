...
import { registerPairbuildrSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@pairbuildr/sdk/v2"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.PAIRBUILDR_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
