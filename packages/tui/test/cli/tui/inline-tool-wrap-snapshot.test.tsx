...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "PAIRBUILDR.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/pairbuildr/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/pairbuildr (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/pairbuildr/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/pairbuildr/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const PAIRBUILDR_DB|PAIRBUILDR_DB|PAIRBUILDR_DEV|Global\\.Path\\.data|data =" in packages/pairbuildr/src (115 matches)',
  },
] as const
