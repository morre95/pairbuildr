...
import type { Definition } from "@pairbuildr/schema/event"
...
export const PairBuildrEvent = event.schema
export type PairBuildrEvent = typeof PairBuildrEvent.Type
export type PairBuildrEventEncoded = typeof PairBuildrEvent.Encoded
