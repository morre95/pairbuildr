...
- Effect plugins import `@pairbuildr/plugin/v2/effect`, not `@pairbuildr/core`.
- Public domain values use generated `@pairbuildr/sdk` types.
...
- Define `PluginHost` domain capabilities in `@pairbuildr/plugin/v2/effect`.
